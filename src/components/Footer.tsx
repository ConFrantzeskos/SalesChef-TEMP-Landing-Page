      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-gray-600 hover:text-purple-700">Enterprise Solutions</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-gray-600 hover:text-purple-700">Resource Center</a></li>
              <li><a href="#" className="text-gray-600 hover:text-purple-700">Case Studies</a></li>
              <li><a href="#" className="text-gray-600 hover:text-purple-700">API</a></li>
        ...
        <div className="border-t border-gray-200 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a href="#" className="text-sm text-gray-500 hover:text-purple-700">Privacy Policy</a>
            <a href="#" className="text-sm text-gray-500 hover:text-purple-700">Terms of Service</a>
            <a href="#" className="text-sm text-gray-500 hover:text-purple-700">Cookie Policy</a>
            <a href="#" className="text-sm text-gray-500 hover:text-purple-700">GDPR</a>
          </div>
        </div>
      </div>
    </footer>
