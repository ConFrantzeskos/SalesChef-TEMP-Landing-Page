...
import { ArrowRight, ChefHat, FileText, ShoppingBag, BarChart2, Sparkles, MessageSquare, Clipboard, ScrollText, Factory, Package2, Image, MessageCircle, TrendingUp, LineChart } from "lucide-react";
        ...
        <div className="flex items-center justify-between h-[300px] md:h-[350px] relative">
          ...
          <div className="w-1/3 flex flex-col items-center h-full relative px-4">
            ...
            <div className="relative h-48 w-full">
              ...
              {/* Text fragments - first set */}
              <div className="absolute top-[15%] left-[25%] text-[9px] text-white/90 bg-white/10 px-2 py-1 rounded">supplier forms</div>
              <div className="absolute top-[35%] left-[15%] text-[9px] text-white/90 bg-white/10 px-2 py-1 rounded">compliance specs</div>
              <div className="absolute top-[55%] left-[20%] text-[9px] text-white/90 bg-white/10 px-2 py-1 rounded">factory specs</div>
              <div className="absolute top-[75%] left-[25%] text-[9px] text-white/90 bg-white/10 px-2 py-1 rounded">product specs</div>
              
              {/* Additional text fragments - second set */}
              <div className="absolute top-[20%] left-[55%] text-[9px] text-white/80 bg-white/10 px-1 rounded">inseam</div>
              <div className="absolute top-[50%] left-[65%] text-[8px] text-white/70 bg-white/10 px-1 rounded">lore</div>
              
              {/* Code-like fragments */}
              <div className="absolute top-[40%] left-[70%] text-[6px] text-white/60 font-mono">{"{data:[]}"}</div>
              <div className="absolute top-[65%] left-[60%] text-[7px] text-white/60 font-mono">{"<attr>"}</div>
            </div>
